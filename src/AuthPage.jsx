...
export default function AuthPage() {
    ...
    return (
        <div style={{
            ...
            {/* Orbs */}
            <div style={{ position: "fixed", top: -120, right: -100, width: 350, height: 350, background: "radial-gradient(circle, rgba(79,70,229,0.12) 0%, transparent 70%)", borderRadius: "50%", pointerEvents: "none" }} />
            <div style={{ position: "fixed", bottom: -80, left: -80, width: 300, height: 300, background: "radial-gradient(circle, rgba(79,70,229,0.08) 0%, transparent 70%)", borderRadius: "50%", pointerEvents: "none" }} />
            <div style={{ position: "fixed", top: "40%", left: "50%", width: 200, height: 200, background: "radial-gradient(circle, rgba(79,70,229,0.06) 0%, transparent 70%)", borderRadius: "50%", pointerEvents: "none", transform: "translate(-50%,-50%)" }} />
            ...
            <div style={{ width: "100%", maxWidth: 440, zIndex: 1, animation: "fadeSlide 0.5s ease" }}>
                ...
                <div style={{ textAlign: "center", marginBottom: 32 }}>
                    ...
                    <div style={{ fontSize: 11, letterSpacing: 4, color: "#4F46E5", textTransform: "uppercase", fontWeight: 700, marginBottom: 4 }}>EventXpense</div>
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", background: "rgba(255,255,255,0.04)", borderRadius: 12, padding: 4, marginBottom: 24 }}>
                        {[{ id: "login", label: "🔐 Sign In" }, { id: "register", label: "✨ Create Account" }].map((t) => (
                            <button key={t.id} onClick={() => switchMode(t.id)} style={{
                                ...
                                background: mode === t.id ? "rgba(79,70,229,0.15)" : "transparent",
                                color: mode === t.id ? "#4F46E5" : "#666",
                                fontSize: 12, fontWeight: 700, fontFamily: "inherit", transition: "all 0.25s",
                                boxShadow: mode === t.id ? "0 2px 8px rgba(79,70,229,0.2)" : "none",
                            }}>{t.label}</button>
                        ))}
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <>
                                ...
                                <div style={{ marginBottom: 20, animation: "fadeSlide 0.3s ease 0.1s both" }}>
                                    ...
                                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                                        {[
                                            { id: "manager", icon: "🏢", lbl: "Manager", desc: "Create events & manage team", color: "#4F46E5" },
                                            { id: "staff", icon: "👷", lbl: "Staff", desc: "Log expenses & track spending", color: "#9CA3AF" },
                                        ].map((r) => (
                        ...
                        {error && (
                            <div style={{
                                ...
                                color: "#EF4444", fontSize: 12, fontWeight: 600, animation: "fadeSlide 0.2s ease",
                        ...
                        <button type="submit" disabled={loading} style={{
                            ...
                            background: loading ? "rgba(255,255,255,0.1)" : "#4F46E5",
                    ...
                    <div style={{ textAlign: "center", marginTop: 20, fontSize: 12, color: "#555" }}>
                        {mode === "login" ? (
                            <>Don't have an account?{" "}<span onClick={() => switchMode("register")} style={{ color: "#4F46E5", cursor: "pointer", fontWeight: 700 }}>Create one</span></>
                        ) : (
                            <>Already have an account?{" "}<span onClick={() => switchMode("login")} style={{ color: "#4F46E5", cursor: "pointer", fontWeight: 700 }}>Sign in</span></>
                        )}
                    </div>
                </div>
